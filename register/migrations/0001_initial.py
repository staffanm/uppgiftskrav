    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('namn', models.CharField(help_text='Tydlig och enkel ben\xe4mning p\xe5 uppgiftskravet s\xe5 att f\xf6retaget f\xf6rst\xe5r vad det inneb\xe4r.', max_length=255, verbose_name='Uppgiftskrav', blank=True)),
                ...
                ('leder_till_insamling', models.IntegerField(blank=True, help_text='Ange Ja om det \xe4r ett uppgiftskrav. Ange Nej om det inte \xe4r ett uppgiftskrav.', null=True, verbose_name='Leder till insamling fr\xe5n f\xf6retag', choices=[(1, 'Ja'), (0, 'Nej')])),
                ...
                ('kalenderstyrt', models.IntegerField(blank=True, help_text='Ange om uppgiften l\xe4mnas in utifr\xe5n f\xf6rutbest\xe4md tidpunkt.', null=True, choices=[(1, 'Ja'), (0, 'Nej')])),
                ...
                ('initierande_part', models.IntegerField(blank=True, help_text='Ange om myndigheten eller f\xf6retaget \n                          initierar uppgiftskravet f\xf6rsta g\xe5ngen.', null=True, choices=[(1, 'Myndighetsinitierat'), (2, 'F\xf6retagsinitierat')])),
                ...
                ('beror_bransch', models.IntegerField(blank=True, null=True, verbose_name='Ber\xf6r specifik bransch', choices=[(1, 'Ja'), (0, 'Nej')])),
                ('arbetsgivare', models.IntegerField(blank=True, help_text='Ange om uppgiftskravet endast ber\xf6r arbetsgivare.', null=True, choices=[(1, 'Ja'), (0, 'Nej')])),
                ('antal_anstallda', models.IntegerField(blank=True, help_text='Ange om uppgiftskravet endast ber\xf6r f\xf6retag som har ett visst antal anst\xe4llda.', null=True, verbose_name='Antal anst\xe4llda', choices=[(1, 'Ja'), (0, 'Nej')])),
                ('anstallda', models.CharField(default='', help_text='Ange svaret med st\xf6rre \xe4n, mindre \xe4n- och likhetstecken f\xf6ljt av siffra > x < y = 200', max_length=100, verbose_name='Anst\xe4llda', blank=True)),
                ('beror_foretagsform', models.IntegerField(blank=True, null=True, verbose_name='Ber\xf6r specifika f\xf6retagsformer', choices=[(1, 'Ja'), (0, 'Nej')])),
                ...
                ('antal_foretag', models.IntegerField(help_text='Antal olika n\xe4ringsidkare/f\xf6retag som har\n                             haft \xe4renden hos myndigheten under 2012\n                             till f\xf6ljd av uppgiftskravet.\n\n                             Ombud avses inte.\n\n                             Skriv svaret med siffror i cellen.', null=True, verbose_name='Antal omfattade f\xf6retag', blank=True)),
                ('annan_ingivare', models.IntegerField(blank=True, help_text='Ange om uppgifter som r\xf6r uppgiftskravet kan l\xe4mnas av ombud f\xf6r\n                         f\xf6retaget (allts\xe5 n\xe5gon som\n                         har fullmakt och inte \xe4r anst\xe4lld).', null=True, choices=[(1, 'Ja'), (0, 'Nej')])),
                ...
                ('etjanst', models.IntegerField(blank=True, help_text='Har ni en e-tj\xe4nst som kan anv\xe4ndas f\xf6r insamling av uppgiftskravet\n                  (dvs tj\xe4nst som m\xf6jligg\xf6r automatiserad behandling\n                  av uppgifterna)?  H\xe4r avses inte t ex\n                  pdf-blankett som m\xe5ste skrivas ut.', null=True, verbose_name='E-tj\xe4nst', choices=[(1, 'Ja'), (0, 'Nej')])),
                ('blankett', models.IntegerField(blank=True, help_text='Har ni en elektronisk blankett (t ex PDF-blankett) som kan fyllas i och l\xe4mnas in med brev, fax, e-post?', null=True, verbose_name='Elektronisk blankett', choices=[(1, 'Ja'), (0, 'Nej')])),
                ('maskintillmaskin', models.IntegerField(blank=True, help_text='Har ni ett maskin-till-maskingr\xe4nssnitt som kan anv\xe4ndas f\xf6r insamling av uppgifter i uppgiftskravet?', null=True, verbose_name='Maskin-till-maskingr\xe4nssnitt', choices=[(1, 'Ja'), (0, 'Nej')])),
                ...
                ('ansvarig_myndighet', models.ForeignKey(related_name='ansvarig_for', blank=True, to='auth.Group', help_text='Myndighet som \xe4r ansvarig f\xf6r ett uppgiftskrav. Samma\n                            som kartl\xe4ggande myndighet utom i de fall\n                            insamling sker f\xf6r annan myndighets  r\xe4kning.', null=True, verbose_name='Ansvarig myndighet')),
                ...
                ('foretagsform', models.ManyToManyField(help_text='Om uppgiftskravet endast ber\xf6r specifika f\xf6retagsformer, ange\n                       dessa.', to='register.Foretagsform', null=True, blank=True)),
                ('kartlaggande_myndighet', models.ForeignKey(related_name='kartlaggande_for', blank=True, to='auth.Group', help_text='Myndighet som\n                                kartlagt uppgiftskravet.', null=True, verbose_name='Kartl\xe4ggande myndighet')),
            ],
            options={
                'ordering': ['id'],
